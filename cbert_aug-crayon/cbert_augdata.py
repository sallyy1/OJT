...
def main():
    ...
    shutil.copytree("style_aug_data/{}".format(task_name), args.output_dir)
    ...
    origin_train_path = os.path.join(args.output_dir, "train.tsv") ###"train_origin.tsv")
    save_train_path = os.path.join(args.output_dir, "train_argumented.tsv")
    shutil.copy(origin_train_path, save_train_path)
    best_test_acc = train_text_classifier.train(
        "style_aug_data_{}_{}_{}_{}".format(args.sample_num, args.sample_ratio, args.gpu, args.temp))
